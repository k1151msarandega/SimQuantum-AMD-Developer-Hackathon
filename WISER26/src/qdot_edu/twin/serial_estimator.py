...
serial_estimator.py. This file was already CPU-only in the original repo
(the GPU path was batch_estimator.py, not this) -- nothing to adapt here.
...
from qdot_edu.perception.ensemble import ensemble_forward
